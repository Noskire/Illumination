...
func get_direction() -> Vector2:
	# Get player input
	var inp_r = Input.get_action_strength("ui_right")
	var inp_l = Input.get_action_strength("ui_left")
	var inp_d = Input.get_action_strength("ui_down")
	var inp_u = Input.get_action_strength("ui_up")
	...
	# if pressing 'Space', invert RayCast
	if b == 1:
